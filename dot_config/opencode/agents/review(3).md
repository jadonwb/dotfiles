...
When several workstreams ran, review their combined result and verify their
boundaries and integration, using every labeled Builder report.
...
3. Map each material requirement, constraint, edge case, workstream boundary,
   and validation criterion to implementation evidence or identify it as
   unmet/unverified.
